...
public class ComAdapter<T> extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public ComAdapter loadHorizontal(RecyclerView rv) {
        return loadHorizontal(rv,false);
    }
    ...
    public ComAdapter loadGridVertical(RecyclerView rv, int spanCount) {
       return loadGridVertical(rv,spanCount,false);
    }
    ...
    public ComAdapter loadGridHorizontal(RecyclerView rv, int spanCount) {
       return loadGridHorizontal(rv,spanCount,false);
    }
    ...
    public ComAdapter loadStaggeredGridHorizontal(RecyclerView rv, int spanCount) {
       return loadStaggeredGridHorizontal(rv,spanCount,false);
    }
    ...
    public ComAdapter loadStaggeredGridVertical(RecyclerView rv, int spanCount) {
        return loadStaggeredGridVertical(rv,spanCount,false);
    }

    /**
     * 设置RecyclerView为垂直状态
     * inScrollView: 是否在ScrollView中
     */
    public ComAdapter loadVertical(RecyclerView rv, Boolean inScrollView) {
        if(inScrollView) {
     ...
     * inScrollView: 是否在ScrollView中
     */
    public ComAdapter loadHorizontal(RecyclerView rv, Boolean inScrollView) {
        if(inScrollView){
     ...
     * inScrollView: 是否在ScrollView中
     */
    public ComAdapter loadGridVertical(RecyclerView rv, int spanCount, Boolean inScrollView) {
        if(inScrollView) {
     ...
     * inScrollView: 是否在ScrollView中
     */
    public ComAdapter loadGridHorizontal(RecyclerView rv, int spanCount, Boolean inScrollView) {
        if(inScrollView) {
     ...
     * inScrollView: 是否在ScrollView中
     */
    public ComAdapter loadStaggeredGridHorizontal(RecyclerView rv, int spanCount, Boolean inScrollView) {
        if(inScrollView){
     ...
     * inScrollView: 是否在ScrollView中
     */
    public ComAdapter loadStaggeredGridVertical(RecyclerView rv, int spanCount, Boolean inScrollView) {
        if(inScrollView){
            ...
            viewHolder.getWholeView().setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    if (onItemClickListener != null) {
                        onItemClickListener.onItemClick(position, t);
                    }
                }
            });
            viewHolder.getWholeView().setOnLongClickListener(new View.OnLongClickListener() {
                ...
                public boolean onLongClick(View view) {
                    if (onItemLongClickListener != null) {
                        onItemLongClickListener.onItemClick(position, t);
                    }
                    return true;
                }
            });
